...
export type SatDomain = keyof typeof SAT_DOMAINS;
export type SatSkillRW = typeof SAT_DOMAINS["Reading & Writing"][number];
export type SatSkillMath = typeof SAT_DOMAINS["Math"][number];
