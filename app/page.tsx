...
import { UploadCloud, Library, FlaskConical, BarChart3, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="px-6 lg:px-12 py-10 lg:py-16 max-w-7xl mx-auto">
      ...
      <div className="mt-14 text-center text-zinc-500 text-[12px]">
        Built for scale • 20k+ Q virtualization • keyboard-first • a11y ready • export JSON/CSV
      </div>
    </div>
  );
}
